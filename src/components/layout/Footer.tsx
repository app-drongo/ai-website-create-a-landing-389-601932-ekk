  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: "Account Aggregation", href: "#features" },
        { name: "Risk Management", href: "#features" },
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Banking Partners", href: "/partners" },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Empowering financial institutions with secure, compliant open banking solutions. 
                Trusted by banks, fintechs, and enterprises worldwide for seamless financial data integration.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">sales@openflow.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            {/* Newsletter Signup */}
            <div className="space-y-3">
              <h4 className="font-semibold text-sm text-foreground">Financial Insights</h4>
              ...
              <p className="text-xs text-muted-foreground">
                Get banking industry updates and OpenFlow product news. Unsubscribe anytime.
              </p>
            </div>
      ...
      <div className="border-t border-muted bg-muted/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Built with <Heart className="size-3 text-accent fill-current" /> for financial innovation
              </span>
            </div>
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-6 mt-4 pt-4 border-t border-muted">
            ...
            <Link href="/api-status" className="text-xs text-muted-foreground hover:text-foreground transition-colors">
              API Status
            </Link>
